            ...
            <?php foreach ($questions as $index => $question): ?>
              ...
              <tr>
                ...
                <td>
                  ...
                  <?php elseif ($question['type'] === 'typing'): ?>
                    <div class="answer-box"><?php if ($isUnanswered): ?><div style="color:#a36b1b">Not answered</div><?php else: ?><details class="typing-answer-reveal"><summary>Show answer</summary><div class="typing-answer-text"><?= nl2br(esc((string) $answer)) ?></div></details><?php endif; ?><div class="typing-verification"><strong>Similarity:</strong> <?= esc(rtrim(rtrim(number_format((float) ($question['similarity_percent'] ?? 0), 2, '.', ''), '0'), '.')) ?>% · <?= esc($question['verification_status'] ?? 'Not evaluated') ?></div></div>
