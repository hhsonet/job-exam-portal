...
<head>
  ...
  <style>
    ...
    .monitor-open{display:inline-block;padding:8px 11px;border-radius:7px;background:#e8f7ef;color:#0f7b4f;font-size:12px;font-weight:700;margin-right:5px}
          ...
          <table>
            ...
            <?php foreach ($exams as $exam): ?>
              ...
              <tr>
                ...
                <td>
                  <a class="monitor-open" href="<?= site_url('admin/exams/' . $exam['id'] . '/monitor') ?>">◉ Monitor</a>
